...
not have to. In the case that the function doesn't have 
a return statement, when you call it, the function processes 
...
The function will change the global sum variable but 
