...
operator, which attempts to convert both values being 
compared to a common type, the strict equality operator 
...
will return the string Equal when val is strictly equal to 7.
*/
// Setup
