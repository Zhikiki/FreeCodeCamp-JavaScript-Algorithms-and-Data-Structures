...
have an advantage on the next hand over the house by keeping track 
...
variable according to the card's value (see table). The function will then 
return a string with the current count and the string Bet if the count is positive, 
