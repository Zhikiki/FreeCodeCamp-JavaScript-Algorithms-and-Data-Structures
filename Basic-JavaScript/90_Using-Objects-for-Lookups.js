...
to lookup values rather than a switch statement or an if/else chain. 
This is most useful when you know that your input data is limited 
to a certain range.
...
Use it to look up val and assign the associated string to the 
result variable.
*/
