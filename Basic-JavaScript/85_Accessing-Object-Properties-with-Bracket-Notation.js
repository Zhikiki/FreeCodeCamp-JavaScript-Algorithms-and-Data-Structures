...
would be the string Spock, and myObj["NoSpace"] would be the string 
USS Enterprise.
...
/*
Read the values of the properties an entree and the drink of testObj using 
bracket notation and assign them to entreeValue and drinkValue respectively.
*/
